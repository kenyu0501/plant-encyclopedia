...
import { ImagePlus, Leaf, LogOut, PlaySquare, Settings, Sprout } from "lucide-react";
  ...
  return (
    <div className="grid gap-3 sm:grid-cols-5">
      ...
      <button
        type="button"
        onClick={signOut}
        className="inline-flex items-center justify-center gap-2 rounded-md border border-leaf-200 bg-white px-4 py-3 text-sm font-semibold text-leaf-800 sm:col-span-5"
      >
        <LogOut size={18} />
        ログアウト
      </button>
