...
まず目を引くのは、一つの園地に植えられた熱帯果樹の多様さです。[ホワイトサポテ](/fruits/white-sapote)や[アボカド](/fruits/avocado)、[パラミツ](/fruits/jackfruit)、[コパラミツ](/fruits/chempedak)などが次々に登場し、同じ果樹でも複数の品種が育てられています。日本では実物を見る機会が少ない果実や樹形を、園地を歩く視点で観察できるのが今回の動画の魅力です。
...
ホワイトサポテの[マクディール](/fruits/white-sapote/cultivars/mcdill)として紹介された果実も試食しています。果肉はやわらかく、甘みが強く、カスタードプリンのような印象です。苦みや渋みをほとんど感じず、現地で食べたことで、この品種が選ばれている理由を実感できました。

熱帯果樹は、品種名だけでなく、実際の樹姿、着果、香り、食感を一緒に見ることで理解が深まります。動画を見ながら[熱帯果樹図鑑](/fruits)の品種情報も確認し、気になった果樹や品種を探してみてください。

関連する図鑑ページ
・[アボカド](/fruits/avocado)
・[ホワイトサポテ](/fruits/white-sapote)
・[マクディール](/fruits/white-sapote/cultivars/mcdill)
・[パラミツ](/fruits/jackfruit)
・[コパラミツ](/fruits/chempedak)$article$,
